...
Welcome to your first week of the WnCC Machine Learning course! To make things easy, we have set up Google Colab templates for you. You don't need to install anything on your laptop.

**How to start:**
1. Click the Colab link for the assignment.
2. Go to `File` -> `Save a copy in Drive`.
3. Start coding in your own copy! 
4. Run the "Sanity Check" cells provided in the notebook to instantly see if your code is correct.

---

## The Main Mission: The Unsinkable Data Visualization (Mandatory)
**Objective:** Get comfortable with Pandas, Data Cleaning, and Matplotlib.
